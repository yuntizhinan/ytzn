...
$content = Get-Content -Path 'C:\Users\PC\.gemini\antigravity-ide\brain\8b324571-b4d1-443b-a1af-f399c24c2d7b\.system_generated\steps\21\content.md' -Raw -Encoding UTF8
$pattern = 'data-reveal="([^"]+)"'
...
[IO.File]::WriteAllText("$(Get-Location)\share-id.html", $shareHtml, [System.Text.Encoding]::UTF8)
Write-Output "Updated share-id.html"
...
"@ + "`n"
        ...
        [IO.File]::WriteAllText("$(Get-Location)\apple-id.html", $appleHtml, [System.Text.Encoding]::UTF8)
        Write-Output "Updated apple-id.html"
    }
}
...
[IO.File]::WriteAllText("$(Get-Location)\protocol-selection-2026.html", $protoHtml, [System.Text.Encoding]::UTF8)
Write-Output "Updated protocol-selection-2026.html"

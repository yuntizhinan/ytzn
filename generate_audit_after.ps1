...
$results | ConvertTo-Json | Set-Content -Path "seo-audit-after-stage2.json" -Encoding UTF8
$txtOutput | Set-Content -Path "seo-audit-after-stage2.txt" -Encoding UTF8
Write-Host "After audit generated."
